...
\beginchorus
\[Em G A Em C G D B]\vspace{-1em}
\[Em G A Bm C Em]\vspace{-1em}
...
It's \[G]vultures jeering at \[B]me                           
...
To \[B]join The Varangian Guard
\endverse

\beginchorus                 
\[Em]Guards of \[G]glory \[A]and of \[Em]might                     
\[C]Red as \[G]blood and \[D]black as \[B]night                 
\[Em]Flies our \[G]banner \[A]as we \[Bm]marc                               
...
\[B5 A5 C5 A5] \vspace{-1em}
\[B5 A5 B5]\vspace{-1em}
\vspace{1em}
\[Am B] \rep{3}\vspace{-1em}
\[C D Em C]\vspace{-1em}
\[Am B]\vspace{-1em}
\endverse
